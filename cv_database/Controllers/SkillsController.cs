...
namespace cv_database.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public SkillsController(cv_databaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Skills != null ? 
                          ...
                          Problem("Entity set 'cv_databaseContext.Skills'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'cv_databaseContext.Skills'  is null.");
            }
            var skills = await _context.Skills.FindAsync(id);
            if (skills != null)
            {
